...
use Atrauzzi\Imager\Processing\Filter;
use Atrauzzi\Imager\Repository\Image as ImageRepository;
...
class Service {
	...
	/** @var \Atrauzzi\Imager\Repository\Image */
	protected $imageRepository;

	/** @var \Intervention\Image\ImageManager */
	protected $intervention;

	/** @var \Atrauzzi\Imager\Storage\Driver[] */
	 ...
	 * @param \Atrauzzi\Imager\Storage\Driver[] $storageDrivers
	 * @throws Exception
	 */
	...
	/**
	 * @param \Atrauzzi\Imager\Model\Image $image
	 * @param array $filters
	 * @return string
	 */
	 ...
	 *
	 * @param File $file
	 * @param \Atrauzzi\Imager\Model\Imageable|\Illuminate\Database\Eloquent\Model $imageable
	 ...
	 *
	 * @param string $uri
	 * @param \Atrauzzi\Imager\Model\Imageable $imageable
	 * @param array $attributes
	 * @return null
	 */
	 ...
	 *
	 * @param null $abstract
	 * @return \Atrauzzi\Imager\Storage\Driver
	 */
	...
	protected function runFilters(File $file, Image $image, array $filters = []) {
		...
		foreach($filters as $key => $filter) {
			...
			/** @var \Atrauzzi\Imager\Processing\Filter $abstract */
