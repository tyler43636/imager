...
class ServiceProvider extends Base {
	...
	public function register() {
		...
		$this->app->bind('Atrauzzi\Imager\Repository\Image', 'Atrauzzi\Imager\Repository\DbImage');
		

		$this->app->singleton('Atrauzzi\Imager\Service', function (Application $app) use ($config) {
			...
			foreach($config->get('imager::storage', []) as $abstract => $driverConfig) {
				...
				/** @var \Atrauzzi\Imager\Storage\Driver $driver */
			...
			$service = new Service(
				$app->make('Atrauzzi\Imager\Repository\Image'),
	...
	public function provides() {
		return [
			...
			'Atrauzzi\Imager\Service',
			'Atrauzzi\Imager\Repository\Image'
		];
	}
